...
class ElasticsearchFieldNormalizerManager extends DefaultPluginManager implements ElasticsearchFieldNormalizerManagerInterface {
  ...
  public function __construct(\Traversable $namespaces, CacheBackendInterface $cache_backend, ModuleHandlerInterface $module_handler) {
    parent::__construct('Plugin/ElasticsearchNormalizer/Field', $namespaces, $module_handler, 'Drupal\elasticsearch_helper_content\ElasticsearchNormalizerInterface', 'Drupal\elasticsearch_helper_content\Annotation\ElasticsearchFieldNormalizer');
